...
import { Register } from '../axios/CostumerApi';
...
export const ReactFinalFormDemo = () => {
    ...
    const RegisterBuyer=()=>{ 
        Register(password,name,phone,email).then(response=>{
    ...
    const validate = (data) => {
        ...
        else if (!/^05?[0-9]-?[0-9]{7}$/i.test(data.phone)) {
                ...
                <div className="card">
                    ...
                    <Form onSubmit={onSubmit} initialValues={{ name: '', email: '', password: '', date: null, country: null, accept: false }} validate={validate} render={({ handleSubmit }) => (
                        <form onSubmit={handleSubmit} className="p-fluid">
                            ...
                            <Button onClick={RegisterBuyer}type="submit" label="Submit" className="mt-2" />
